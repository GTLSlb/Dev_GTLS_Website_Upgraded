...
export type RecentPostsProps = RecentPostsDataType;

const RecentPosts = ({ title,items }: RecentPostsProps) => {
  return (
    <div className=" w-full flex flex-col gap-10 md:w-5/12">
      <div className="flex flex-col px-6 pb-6 gap-0 border border-color-[#6e6f7a] rounded-3xl h-auto">
        ...
        <Button
          variant={"outline"}
          className="text-gold border-gold rounded-full mt-5 hover:bg-gold hover:text-creamy hover:cursor-pointer"
        >
          View All
        </Button>
      </div>
