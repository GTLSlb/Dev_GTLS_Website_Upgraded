...
const HighlightedSearchResultsList: React.FC<HighlightedSearchResultsListProps> = ({ maxScore, hits, query }) => {
    ...
    <ul className="flex flex-col gap-3 my-2 mb-6">
      {hits.map((hit, index) => {
        ...
        return (
          ...
          <li key={`${hit.type}-${hit.id}-${index}`}>
            <div className="border border-gray-200 rounded-lg p-4 hover:border-[#eacc87] hover:shadow-md hover:cursor-pointer transition-all">
