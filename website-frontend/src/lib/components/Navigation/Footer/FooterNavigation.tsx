        ...
        <SectionContainer className="!pt-0 !pb-0">
          <div className="flex flex-col md:flex-row gap-20 lg:gap-28">
            ...
            <div className="flex w-full md:w-5/12 flex-col gap-8">
              ...
              <div className="flex items-center w-full gap-4">
                <input
                  type="email"
                  className="px-4 py-2 rounded-full border border-black bg-white w-full focus:ring-2 focus:ring-gold focus:outline-none"
                ...
                <Button
                  variant="outline"
                  type="submit"
                  className="border-gold text-gold hover:bg-gold hover:text-creamy hover:cursor-pointer rounded-full py-5"
          ...
          <div className="w-full border-t border-gray-300 mt-12 pt-6">
            <div className="flex justify-end">
              <TextWrapper
                text="© 2025 GTLS. All rights reserved."
                fontFamily="dmSans"
                styleType="link"
              />
            </div>
